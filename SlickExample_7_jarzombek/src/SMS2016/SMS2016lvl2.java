...
public class SMS2016lvl2 extends BasicGameState {
	...
	public SMS2016lvl2(int xSize, int ySize) {
	}
	...
	throws SlickException {
		...
		gc.setShowFPS(false);
		grassMap = new TiledMap("res/road.tmx");
	...
	throws SlickException {
		...
		g.drawString("time passed: " + 1000, camera.cameraX +600,camera.cameraY );
